-- Sautero — recipe SECTIONS scoped per shelf (Richard, 16.7. neskoro večer): opening My Recipes
-- or Company Recipes showed the FULL Sautero taxonomy (Bakery & Bread, Sushi Basics, 11 sections
