-- ChefOS — one-off fix (Richard, 16.7.): chefos@protonmail.com was created earlier today
...
-- ChefOS ingredient + recipe shelves automatically, Check List starts empty. The friendship
