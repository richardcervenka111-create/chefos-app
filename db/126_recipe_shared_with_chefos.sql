-- ChefOS — "share this recipe with ChefOS" (Richard, 17.7.): when saving a recipe, the app now
-- asks whether to contribute it to the ChefOS library. Saying yes ALSO makes every AI helper
...
-- ChefOS shelf: Richard reviews contributions (select shared_with_chefos = true rows) and
