-- Sautero — AI credit balance for Personal accounts (Richard, 16.7., follow-up to db/97/bod 8).
--
...
-- monetization plan), the app credits 70% of that amount (Sautero keeps a ~30% margin), and every
