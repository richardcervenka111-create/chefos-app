...
neznáme a je to tak označené.

## Kto je Gronda

- **Gronda GmbH, Innsbruck (Rakúsko)**, založená 2016, zakladatelia Tobias Zetzsche a Valentin
  Schuetz. ~47 zamestnancov (Dealroom/Craft).
- **Financovanie: spolu ~$2,16M**, posledné kolo Series A **$1,66M vo februári 2020**
  (investori: Speedinvest, karriere.at, HOWZAT Partners). Od 2020 žiadne verejne známe ďalšie
  kolo — buď žijú z tržieb, alebo rastú pomaly. Na pomery „najväčšej komunity kuchárov sveta"
  je to veľmi málo kapitálu.
- **Publikum:** sami uvádzajú 1,1–2M+ kuchárov celosvetovo, 170K+ zdieľaných „creations",
  50 000+ receptov od top šéfkuchárov, 60+ masterclassov (Ana Roš a pod.).
- **História (neoverené, z môjho staršieho poznania):** okolo 2022–23 sa výrazne venovali aj
  gastro jobom / employer brandingu; dnešný web je späť plne pri obsahu a komunite. Ak by došlo
  na rokovania, toto si treba overiť priamo.

## Ich biznis model (2026)

1. **Gronda PRO** — predplatné pre jednotlivého kuchára: exkluzívne recepty, techniky,
   masterclassy. Existuje aj **PRO for Teams** a **PRO for Schools** (ceny neverejné na
   hlavnej stránke).
2. **Creator Program** — kuchári-tvorcovia zarábajú na svojich receptoch a značke
   (revenue-share model, presné podiely neverejné). „Creator of the Year" (Jules Cooking,
   37k followers) — budujú si hviezdy.
...
4. **PRO for Teams / Schools ako segmentácia** — presne zrkadlí náš Chef Pro (jednotlivec) vs
   ...
   je zaujímavý tretí segment aj pre nás (gastro školy — súvisí so zaparkovaným nápadom
   študentskej práce).
5. **Čo NEROBIŤ podľa Gronda:** 10 rokov, ~$2M kapitálu a stále content biznis s neverejnými
   tržbami — obsah sa monetizuje ťažko a pomaly. Potvrdzuje našu stávku: predávať nástroj,
   ktorý kuchyni denne šetrí peniaze (food cost, HACCP pokuty, čas), nie obsah.
...
- **Riziko pri rokovaniach:** funkčné detaily (HACCP engine, food cost, AI skeny) neukazovať
  do hĺbky, kým nie je podpísané NDA — 47-členný tím by vedel funkcie dostavať.

## Akčné body

- [ ] Po triali: pripraviť 1-stranový partnership pitch pre Grondu (ich publikum × náš nástroj).
- [ ] Founding ponuka: doplniť sociálny dôkaz v štýle „X % pilotných kuchárov hovorí…".
- [ ] Overiť aktuálny stav Gronda jobs vetvy pred akýmkoľvek kontaktom.
